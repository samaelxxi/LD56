...
{
    [SerializeField] private SaveTextureToFileUtility.SaveTextureFileFormat _fileFormat = SaveTextureToFileUtility.SaveTextureFileFormat.PNG;
    ...
    {
        SaveTextureToFileUtility.SaveRenderTextureToFile(_renderTexture, "Assets/_Project/Art/RT", _fileFormat);
    }
}
